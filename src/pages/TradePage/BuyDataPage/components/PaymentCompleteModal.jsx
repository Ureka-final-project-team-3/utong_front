  ...
  return (
    <div className="absolute inset-0 bg-black/30 backdrop-blur-sm z-50 flex items-center justify-center">
      <div className="w-[284px] bg-[#F6F6F6] rounded-[10px] p-5 shadow-lg flex flex-col gap-4 text-center">
        {/* 제목 */}
        <p className="text-[#2C2C2C] opacity-60 font-bold text-[18px]">분할 구매 완료</p>
        ...
        {/* 포인트 및 버튼 */}
        <p className="text-[#555] text-sm font-medium">결제 후 보유 포인트 : {point}P</p>
        <button
          className="w-full bg-[#386DEE] text-white font-semibold py-2 rounded-md text-sm cursor-pointer"
          onClick={handleClose}
        >
          닫기
        </button>
